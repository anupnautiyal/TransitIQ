...
export default function AddShipmentPage() {
    ...
    return (
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div className="lg:col-span-2 glass-panel p-8 md:p-12 relative overflow-hidden">
                        {showSuccess && (
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        <div className="glass-panel h-[400px] relative overflow-hidden rounded-3xl border border-white shadow-2xl">
                        ...
                        <div className="glass-panel p-6 border-l-4 border-brand-500">
                             <h4 className="text-[10px] font-black text-slate-900 uppercase tracking-widest mb-2 shadow-sm">AI Deployment Insight</h4>
                             <p className="text-[11px] text-slate-500 leading-relaxed font-medium">
                                Once initialized, the Intelligence Agent will perform real-time sensor fusion on this route. If disruptions are detected, optimized rerouting recommendations will be issued automatically.
                             </p>
                        </div>
                    </div>
                </div>
